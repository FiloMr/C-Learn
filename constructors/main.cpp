...
int main() {
 ...
 Pracownik pracownik; // wywołanie niejawnego konstruktora klasy Pracownik w sposób niejawny
 Pracownik pracownik=Pracownik();//Niejawny konstruktor jawnie wywołany
 /* UWAGA
